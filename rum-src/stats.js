...
function felizNavidad(date, month,year,mauApa){
	...
	var viewsJune= [1355,1376,1392,1408,1424,1443,1458,1468,1474,1481,1488,1496,1503,1509,1516,1522,1540,1559,1572];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
...
function solamente(date,month,year,mauApa){
	...
	var viewsJune= [2375,2396,2419,2438,2456,2480,2495,2504,2511,2517,2524,2532,2539,2546,2553,2558,2583,2600,2617];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function soloGitar(date,month,year,mauApa){
	...
	var viewsJune= [1091,1113,1137,1160,1178,1194,1207,1215,1221,1227,1234,1243,1252,1259,1264,1270,1286,1305,1325];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
