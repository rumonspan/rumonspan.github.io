...
function felizNavidad(date,month,year,mauApa){
	...
	var viewsJune= [1355,1376,1392,1408,1424,1443,1458,1468,1474,1481,1488,1496,1503,1509,1516,1522,1540,1559,1572,1583,1600,1636,1662,1680,1697,1712,1727];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
...
function solamente(date,month,year,mauApa){
	...
	var viewsJune= [2375,2396,2419,2438,2456,2480,2495,2504,2511,2517,2524,2532,2539,2546,2553,2558,2583,2600,2617,2634,2661,2717,2748,2778,2792,2813,2835];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function soloGitar(date,month,year,mauApa){
	...
	var viewsJune= [1091,1113,1137,1160,1178,1194,1207,1215,1221,1227,1234,1243,1252,1259,1264,1270,1286,1305,1325,1335,1358,1388,1412,1443,1463,1482,1497];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
