...
function felizNavidad(date,month,year,mauApa){
	...
	var viewsJuly=[1838,1856,1865,1875,1887,1908,1925,1941,1952,1970,1991,2009,2013,2031,2049,2059,2074,2099,2114,2131,2150,2166,2194,2209,2235];
	var viewsAugust=[];
	if (year==2021){
...
function solamente(date,month,year,mauApa){
	...
	var viewsJuly=[2971,3030,3068,3082,3097,3135,3167,3231,3277,3332,3374,3397,3441,3482,3507,3534,3564,3609,3629,3673,3734,3778,3843,3892,3949];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function soloGitar(date,month,year,mauApa){
	...
	var viewsJuly=[1621,1638,1655,1667,1681,1708,1732,1751,1758,1771,1784,1800,1808,1825,1844,1858,1875,1886,1900,1915,1931,1942,1952,1963,1976];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
